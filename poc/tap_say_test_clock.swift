...
task.arguments = ["Testing tap capture right now one two three four five six seven eight nine ten"]
task.launch()

Thread.sleep(forTimeInterval: 0.5)

let bundleID = "com.apple.speech.speechsynthesisd"
...
print("Matched speechsynthesisd: \(matched)")
...
print("Using subdevice UID: \(defUID)")
