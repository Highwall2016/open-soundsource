...
struct AppRow: View {
    ...
    var body: some View {
        ...
        .padding(.horizontal, 12)
            ...
            // Volume slider for active routing
            if case .active = app.routingState {
                HStack(spacing: 6) {
                    Image(systemName: app.volume == 0 ? "speaker.slash.fill" : "speaker.fill")
                        .font(.system(size: 10))
                        .foregroundColor(.secondary)
                        .frame(width: 14)
                    ...
                    Slider(
                        value: Binding(
                            get: { app.volume },
                            set: { audioManager.setVolume(for: app.pid, volume: $0) }
                        ),
                        in: 0...1
                    )
                    .controlSize(.mini)
